...
class ReprojectionError3 {
 public:
  ...
  bool operator()(const T* const point, T* residuals) const {
    T q_cam_odo[4] = {
        T(m_cam_odo_q.coeffs()(0)), T(m_cam_odo_q.coeffs()(1)), T(m_cam_odo_q.coeffs()(2)), T(m_cam_odo_q.coeffs()(3))};
  ...
  switch (flags) {
    ...
    case CAMERA_INTRINSICS | CAMERA_ODOMETRY_TRANSFORM | ODOMETRY_3D_POSE | POINT_3D:
      switch (camera->modelType()) {
        ...
        case Camera::SCARAMUZZA:
          if (optimize_cam_odo_z) {
            costFunction = new ceres::
                AutoDiffCostFunction<ReprojectionError3<OCAMCamera>, 2, SCARAMUZZA_CAMERA_NUM_PARAMS, 4, 3, 2, 1, 3>(
                    new ReprojectionError3<OCAMCamera>(observed_p));
          } else {
            costFunction = new ceres::
                AutoDiffCostFunction<ReprojectionError3<OCAMCamera>, 2, SCARAMUZZA_CAMERA_NUM_PARAMS, 4, 2, 2, 1, 3>(
                    new ReprojectionError3<OCAMCamera>(observed_p));
          }
          break;
      }
    ...
    case CAMERA_INTRINSICS | CAMERA_ODOMETRY_TRANSFORM | ODOMETRY_6D_POSE | POINT_3D:
      switch (camera->modelType()) {
        ...
        case Camera::SCARAMUZZA:
          if (optimize_cam_odo_z) {
            costFunction = new ceres::
                AutoDiffCostFunction<ReprojectionError3<OCAMCamera>, 2, SCARAMUZZA_CAMERA_NUM_PARAMS, 4, 3, 3, 3, 3>(
                    new ReprojectionError3<OCAMCamera>(observed_p));
          } else {
            costFunction = new ceres::
                AutoDiffCostFunction<ReprojectionError3<OCAMCamera>, 2, SCARAMUZZA_CAMERA_NUM_PARAMS, 4, 2, 3, 3, 3>(
                    new ReprojectionError3<OCAMCamera>(observed_p));
          }
          break;
      }
...
ceres::CostFunction* CostFunctionFactory::generateCostFunction(const CameraConstPtr& cameraL,
  ...
  switch (cameraL->modelType()) {
    ...
    case Camera::MEI:
      ...
      break;
    case Camera::SCARAMUZZA:
      costFunction = new ceres::AutoDiffCostFunction<StereoReprojectionError<OCAMCamera>,
                                                     4,
