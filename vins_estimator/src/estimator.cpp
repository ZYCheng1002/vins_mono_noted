...
void Estimator::double2vector() {
  ...
  if (relocalization_info) {
    ...
    relo_t =
        rot_diff *
            Vector3d(relo_Pose[0] - para_Pose[0][0], relo_Pose[1] - para_Pose[0][1], relo_Pose[2] - para_Pose[0][2]) +
        origin_P0;
      ...
      if (ESTIMATE_TD) {
        ...
        */
        ...
        problem.AddResidualBlock(
            f, loss_function, para_Pose[imu_i], para_Pose[imu_j], para_Ex_Pose[0], para_Feature[feature_index]);
      }
      f_m_cnt++;
    }
  }
    ...
    for (auto& it_per_id : f_manager.feature) {
      ...
      if (start <= relo_frame_local_index) {
        ...
        if ((int)match_points[retrive_feature_index].z() == it_per_id.feature_id) {
          ...
          ProjectionFactor* f = new ProjectionFactor(pts_i, pts_j);
          problem.AddResidualBlock(
              f, loss_function, para_Pose[start], relo_Pose, para_Ex_Pose[0], para_Feature[feature_index]);
          retrive_feature_index++;
        }
      }
    }
